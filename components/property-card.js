...
const PropertyCard = ({
  ...
  imageDimensionsTextArray2,
  imageDimensionsTextArray3,
  imageDimensionsTextArray4,
  propWidth,
  propFlex,
  propMinWidth,
  propMaxWidth,
